  ...
  try {
    ...
    if (!supabaseUrl || !serviceRoleKey) {
      return NextResponse.json({
        success: true,
        isSimulated: true,
        message: `Invitation enregistrée pour ${name || email}. (Configurez SUPABASE_SERVICE_ROLE_KEY pour l'envoi d'emails SMTP personnalisé)`,
      });
    }
    ...
    // 2. Fallback: Trigger OTP magic link invitation
